...
(:axiom (illegal) (not (exists (?l - lander ?w - waypoint) (at_lander ?l ?w))))
(:axiom (illegal) (exists (?l1 ?l2 - lander) (not (= ?l1 ?l2))))
...
;; rover equipped for
(:axiom (illegal) (not (exists (?r - rover) (equipped_for_soil_analysis ?r))))
(:axiom (illegal) (not (exists (?r - rover) (equipped_for_rock_analysis ?r))))
(:axiom (illegal) (not (exists (?r - rover) (equipped_for_imaging ?r))))

;; all stores are empty (i. e., also not full)
(:axiom (illegal) (exists (?s - store) (not (empty ?s))))
(:axiom (illegal) (exists (?s - store) (full ?s)))
...
(:axiom (tc_visible ?x ?y - waypoint) (visible ?x ?y))
(:axiom (tc_visible ?x ?y - waypoint)
  (exists (?z - waypoint) (and (tc_visible ?x ?z) (visible ?z ?y))))
(:axiom (illegal) (exists (?x ?y - waypoint) (not (tc_visible ?x ?y))))
...
(:axiom (tc_can_traverse ?r - rover ?x ?y - waypoint) (can_traverse ?r ?x ?y))
(:axiom (tc_can_traverse ?r - rover ?x ?y - waypoint)
  (exists (?z - waypoint)
