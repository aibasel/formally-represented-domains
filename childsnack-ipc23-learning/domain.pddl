...
(:legality-axiom (illegal) (not (exists (?ch - child ?pl - place) (waiting ?ch ?pl))))

;; there is at least one tray (as a side effect, the following axiom also
;; requires that there is at least one place)
(:legality-axiom (illegal) (not (exists (?t - tray ?p - place) (at ?t ?p))))

;; all trays are in the kitchen (and nowhere else)
(:legality-axiom (illegal) (exists (?t - tray) (not (at ?t kitchen))))
(:legality-axiom (illegal) (exists (?t - tray ?p - place) (and (at ?t ?p)
                                                      (not (= ?p kitchen)))))

;; there are at least as many sandwiches as children
(:legality-axiom (matching-child-sandwich ?c - child ?s - sandwich)
...
(:legality-axiom (matching-sandwich-bread ?s - sandwich ?b - bread-portion)
...
(:legality-axiom (matching-sandwich-content ?s - sandwich ?c - content-portion)
  (and (forall (?sx - sandwich) (or (= ?s ?sx) (< ?s ?sx)))
...
(:legality-axiom (illegal) (exists (?b - bread-portion) (not (at_kitchen_bread ?b))))
(:legality-axiom (illegal) (exists (?c - content-portion) (not (at_kitchen_content ?c))))

; all children are either allergic to gluten, or not allergic to gluten
(:legality-axiom (illegal) (exists (?c - child) (and (allergic_gluten ?c)
                                            (not_allergic_gluten ?c))))
(:legality-axiom (illegal) (exists (?c - child) (and (not (allergic_gluten ?c))
...
(:legality-axiom (matching-no-gluten-child-bread ?ch - child ?br - bread-portion)
...
(:legality-axiom (matching-no-gluten-child-content ?ch - child ?co - content-portion)
  (and (allergic_gluten ?ch)
       (no_gluten_content ?co)
       (forall (?chx - child) (or (not (allergic_gluten ?chx)) (= ?ch ?chx) (< ?ch ?chx)))
       (forall (?cox - content-portion) (or (not (no_gluten_content ?cox)) (= ?co ?cox) (< ?co ?cox)))))

(:legality-axiom (matching-no-gluten-child-bread ?ch - child
                                    ?br - bread-portion)
...
(:legality-axiom (illegal) (exists (?c - child) (waiting ?c kitchen)))

;; no child is served (yet)
(:legality-axiom (illegal) (exists (?c - child) (served ?c)))
...
(:legality-axiom (illegal) (exists (?s - sandwich) (not (notexist ?s))))
